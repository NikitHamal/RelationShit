...
public class DeepseekApiService implements BaseApiService {
  ...
  public void getChatCompletion(
    ...
    try {
      deepseekApi.getChatCompletion(
          model,
          messages,
          false, // Stream is always false for now
          new Callback() {
            @Override
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
              Log.e("DeepseekApiService", "API call failed: " + e.getMessage());
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
              if (!response.isSuccessful() || response.body() == null) {
                ...
                Log.e(
                    "DeepseekApiService", "API error: " + response.code() + " - " + errorBody);
              ...
              try {
                ...
                Log.e("DeepseekApiService", "JSON parsing error: " + e.getMessage());
                callback.onError("Failed to parse AI response.");
              }
            }
          });
    } catch (Exception e) {
      Log.e("DeepseekApiService", "Error setting up API call: " + e.getMessage());
  ...
  public void generateConversationTitle(
    ...
    try {
      ...
      Log.e("DeepseekApiService", "Title generation JSON error: " + e.getMessage());
    ...
    getChatCompletion(
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          public void onSuccess(String result) {
            // Remove all characters that are not letters or spaces, and trim whitespace
            String cleanedTitle = result.replaceAll("[^a-zA-Z\\s]", "").trim();
            // If the title becomes empty after cleaning, provide a default one
          ...
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Title generation failed: " + errorMessage);
  ...
  public void considerGeneratingKnowledge(
    ...
    try {
      ...
      Log.e("DeepseekApiService", "Knowledge consideration JSON error: " + e.getMessage());
    ...
    getChatCompletion(
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          public void onSuccess(String result) {
            try {
              // Clean the string to remove markdown code blocks if present
              ...
              Log.e(
                  "DeepseekApiService",
                  "Failed to parse knowledge JSON: " + result + " Error: " + e.getMessage());
          ...
          @Override
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Knowledge consideration failed: " + errorMessage);
            callback.onError(errorMessage);
          }
        });
  }
  ...
  public void summarizeConversation(
    ...
    try {
      ...
      Log.e("DeepseekApiService", "Summarization JSON error: " + e.getMessage());
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          public void onSuccess(String result) {
            try {
              ...
              String content =
                  summaryJson.optString("content", "Summary not available.").replace("\"", "").trim();
              ...
              Log.e(
                  "DeepseekApiService",
                  "Failed to parse summary JSON: " + result + " Error: " + e.getMessage());
          ...
          @Override
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Summarization failed: " + errorMessage);
            callback.onError(errorMessage);
          }
        });
  }
  ...
  public void generateInsights(
    ...
    try {
      JSONObject userMsg = new JSONObject();
      userMsg.put("role", "user");
      userMsg.put("content", insightsPrompt);
      messagesArray.put(userMsg);
    } catch (JSONException e) {
      Log.e("DeepseekApiService", "Insights generation JSON error: " + e.getMessage());
    ...
    getChatCompletion(
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          @Override
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Insights generation failed: " + errorMessage);
            callback.onError(errorMessage);
          }
        });
  }
  ...
  public void generatePsychologicalSurvey(
    ...
    try {
      JSONObject userMsg = new JSONObject();
      userMsg.put("role", "user");
      userMsg.put("content", surveyPrompt);
      messagesArray.put(userMsg);
    } catch (JSONException e) {
      Log.e("DeepseekApiService", "Survey generation JSON error: " + e.getMessage());
    ...
    getChatCompletion(
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          @Override
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Survey generation failed: " + errorMessage);
            callback.onError(errorMessage);
          }
        });
  }
  ...
  public void analyzeSurveyAnswers(
    ...
    try {
      JSONObject userMsg = new JSONObject();
      userMsg.put("role", "user");
      userMsg.put("content", analysisPrompt);
      messagesArray.put(userMsg);
    } catch (JSONException e) {
      Log.e("DeepseekApiService", "Analysis generation JSON error: " + e.getMessage());
    ...
    getChatCompletion(
        ...
        new BaseApiService.ApiResponseCallback<String>() {
          ...
          @Override
          public void onError(String errorMessage) {
            Log.e("DeepseekApiService", "Analysis generation failed: " + errorMessage);
            callback.onError(errorMessage);
          }
        });
  }
